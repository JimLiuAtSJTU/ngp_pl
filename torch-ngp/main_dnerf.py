...
if __name__ == '__main__':
    ...
    if opt.test:
        ...
        trainer = Trainer('ngp', opt, model, device=device, workspace=opt.workspace, optimizer=optimizer, criterion=criterion, ema_decay=0.95, fp16=opt.fp16, lr_scheduler=scheduler, scheduler_update_every_step=True, metrics=[PSNRMeter(),SSIMMeter(),LPIPSMeter(),MS_SSIM_Meter()], use_checkpoint=opt.ckpt, eval_interval=50)
